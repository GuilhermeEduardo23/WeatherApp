...
- [Axios](https://axios-http.com/) para requisições HTTP à API do OpenWeather.
- [OpenWeather API](https://openweathermap.org/api) para obtenção dos dados meteorológicos.
...
### Technologies Used
- [React](https://react.dev/) for building the interface.
- [Vite](https://vitejs.dev/) for fast development environment.
- [Axios](https://axios-http.com/) for HTTP requests to the OpenWeather API.
